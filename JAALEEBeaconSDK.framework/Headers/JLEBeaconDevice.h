...
@property (nonatomic, weak)     id <JLEBeaconDeviceDelegate>  JAALEEdelegate;
...
- (void) ConfigureBeaconAsEddyStoneNameSpaceID:(NSString*)namespaceID InstanceID:(NSString*)InstanceID measuredPowerValue:(int)measuredPowerValue WithCompletion:(JLEBoolCompletionBlock)completion;

- (void) EnableBeaconToEddyStoneModeConnectable:(BOOL)connectable WithCompletion:(JLEBoolCompletionBlock)completion;
